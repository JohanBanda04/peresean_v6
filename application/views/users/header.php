...
<!--                    <li class="has-sub --><?php //if($menu=='harmonisasi' OR ($menu=='harmonisasi' AND $sub_menu=='v') OR ($menu=='folder_data_dukung' AND $sub_menu=='v') OR ($menu=='data_dukung' AND $sub_menu=='v') OR ($menu=='rpd' AND $sub_menu=='v') OR ($menu=='ankabut' AND $sub_menu=='v')){echo " active";} ?><!--">-->
                    ...
                    if(
                        ($menu=='harmonisasi' AND $sub_menu=='v' AND $sub_menu3=='pemprov_ntb')
                        OR
                        ($menu=='harmonisasi' AND $sub_menu=='v2' AND $sub_menu3=='pemprov_ntb')
                        OR
                        ...
                        OR
                        ($menu=='harmonisasi' AND $sub_menu=='v2' AND $sub_menu3=='pemkab_lombok_utara')
                        OR
                        ($menu=='harmonisasi' AND $sub_menu=='v' AND $sub_menu3=='pemkab_lombok_timur')
                        OR
                        ($menu=='harmonisasi' AND $sub_menu=='v2' AND $sub_menu3=='pemkab_lombok_timur')
                        OR
                        ($menu=='harmonisasi' AND $sub_menu=='v' AND $sub_menu3=='pemkab_lombok_tengah')
                        OR
                        ($menu=='harmonisasi' AND $sub_menu=='v2' AND $sub_menu3=='pemkab_lombok_tengah')
                        OR
                        ($menu=='harmonisasi' AND $sub_menu=='v' AND $sub_menu3=='pemkab_lombok_barat')
                        OR
                        ($menu=='harmonisasi' AND $sub_menu=='v2' AND $sub_menu3=='pemkab_lombok_barat')
                        OR
                        ($menu=='harmonisasi' AND $sub_menu=='v' AND $sub_menu3=='pemkab_dompu')
                        OR
                        ($menu=='harmonisasi' AND $sub_menu=='v2' AND $sub_menu3=='pemkab_dompu')
                        OR
                        ($menu=='harmonisasi' AND $sub_menu=='v' AND $sub_menu3=='pemkab_bima')
                        OR
                        ($menu=='harmonisasi' AND $sub_menu=='v2' AND $sub_menu3=='pemkab_bima')
                    ...
                    <li class="has-sub<?php if($menu=='harmonisasi' and $sub_menu=='v' and $sub_menu3=='t'){ echo " active"; } ?>">
