...
<div id="content" class="content">
	  ...
	  <!-- end breadcrumb -->
	  <!-- begin page-header -->
	  <h1 class="page-header" style="font-size: 25px">Dashboard <small> <?php echo ucwords($cek->level);?></small></h1>
        ...
        <div class="panel panel-inverse">
            <div class="panel-body">
                <div style="margin-left: 3px" class="row">
                    ...
                    <br>
<!--                    <a href="--><?php //echo $link1; ?><!--/--><?php //echo $link2; ?><!--/t.html" class="btn btn-primary"><i class="fa fa-plus-circle"></i> Tambah Dokumen </a>-->
                    <a href="harmonisasi/v/t.html" class="btn btn-primary"><i class="fa fa-plus-circle"></i> Tambah Dokumen </a>

                </div>

                <hr>
                <h5>Lihat Dokumen Hasil Harmonisasi</h5>
                <div class="row">
